...
const SubmitTask = ({ setSubmitTask, taskName }) => {
  ...
  async function submitTask() {
    ...
    if (isgrp) {
      ...
      response = await fetch(
        `${import.meta.env.VITE_API_URL}/task/submit`,
        {
          method: "POST",
          headers: {
    ...
    <div className="subt-cont">
      <div className="subt-inner-cont">
        ...
        <div className="subt-inner-mid">
          <div className="subt-mid-text">Your Task Link</div>
          <input
            type="text"
            value={taskLink}
          ...
          {isgrp && (
            <>
              <div className="subt-mid-text">Your Team Name</div>
              <input
                type="text"
                value={teamName}
