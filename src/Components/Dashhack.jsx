      ...
      <div className="dh-left-cont">
        <div className="dh-left-top-cont">
          ...
          <div className="dh-left-card-btm">
            <div className="dh-ps-text">Released on 31 march</div>
            <a
            ...
            <div className="dh-left-card-submit-cont">
              ...
              <div className="dh-sd-det">
                Submission Deadline:{" "}
                <b className="dh-sd-det-text">07 April 10:00PM</b>
              </div>
              <div
                className="dt-sd-cta"
                onClick={() => {
                  // window.open(
                  //   "https://docs.google.com/forms/d/1bb-Y9j24gj-bHhJR2ZUofAMnZt5kGqnlhdSIGZEMsOc",
                  //   "_blank"
                  // );
                  alert("Deadline exceeded");
                }}
              >
